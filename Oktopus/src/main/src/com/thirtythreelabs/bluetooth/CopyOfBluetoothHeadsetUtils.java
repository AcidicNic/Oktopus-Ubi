package com.thirtythreelabs.bluetooth;
...
public class CopyOfBluetoothHeadsetUtils
{
     ...
     * @param context
     */
    public CopyOfBluetoothHeadsetUtils(Context context)
    {
        mContext = context;
	...
	protected CountDownTimer mCountDown11 = new CountDownTimer(10000, 1000)
	{
